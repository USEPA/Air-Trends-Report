...
//  config.symbology = {colors:[d3.rgb(0,80,81)],breaks:[]};
  ...
  config.types = {};
  config.types.Lead = {fullName:"Lead PM10 LC",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.BenzoPyrene = {gpoField: "PAH_POM",fullName:"Benzo(a)pyrene (Total TSP & Vapor)",minYear:2008,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Naphthalene = {gpoField: "NAPHTH",fullName:"Naphthalene (Total TSP & Vapor)",minYear:2008,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.VinylChloride = {gpoField: "VINYCHLRI",fullName:"Vinyl Chloride",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.CarbonTetrachloride = {gpoField: "CARBONTET",fullName:"Carbon Tetrachloride",minYear:2003,maxYear:2020};
  config.types.EthyleneDichloride = {gpoField: "ETHIDDICHLD",fullName:"Ethylene Dichloride",minYear:2004,maxYear:2020};
  config.types.Benzene = {fullName:"Benzene",minYear:2003,maxYear:2020};
  config.types.Chloroform = {gpoField: "CHCL3",fullName:"Chloroform",minYear:2003,maxYear:2020};
  config.types.Ethylbenzene = {gpoField: "ETHYLBENZ",fullName:"Ethylbenzene",minYear:2003,maxYear:2020};
  config.types.MethyleneChloride = {gpoField: "MECL",fullName:"Methylene Chloride",minYear:2003,maxYear:2020};
  config.types.Trichloroethylene = {gpoField: "CL3_ETHE",fullName:"Trichloroethylene",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Butadiene = {gpoField: "BUTADIE",fullName:"1,3-Butadiene",minYear:2003,maxYear:2020};
  config.types.Toluene = {fullName:"Toluene",minYear:2003,maxYear:2020};
  config.types.Acetaldehyde = {gpoField: "ACETALD",fullName:"Acetaldehyde",minYear:2003,maxYear:2020};
  config.types.Formaldehyde = {gpoField: "FORMALD",fullName:"Formaldehyde",minYear:2003,maxYear:2020};
  config.types.Tetrachloroethylene = {gpoField: "PERC",fullName:"Tetrachloroethylene",minYear:2003,maxYear:2020};
  config.types.Nickel = {fullName:"Nickel PM10 LC",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Manganese = {fullName:"Manganese PM10 LC",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Arsenic = {fullName:"Arsenic PM10 LC",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Cadmium = {fullName:"Cadmium PM10 LC",minYear:2003,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Chromium = {gpoField: "CHROMHEX",fullName:"Chromium VI LC",minYear:2005,maxYear:2012,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Beryllium = {fullName:"Beryllium PM10 LC",minYear:2004,maxYear:2020,multiplier:1000,units:"ng/m\u00B3"};
