...
//Set up the Map parameters for each pollutant  
  ...
  pollutantData.co = {file:"euninterp42101MAX2Vmasterfile.csv",title:"CO 8-hour Concentration",standard:9,units:"ppm",digits:1,pollutantLabel:"CO",usedInNatAggRange:[1990,2019]}
...
//Note used unicode characters to get subscripts for svg in charts  
  pollutantData.pb = {file:"euninterp14129RQMAXmasterfile.csv",title:"Pb 3-month Concentration",standard:.15,units:"\u03BCg/m\u00B3",digits:2,pollutantLabel:"Lead",usedInNatAggRange:[2010,2019]}
...
//Note used unicode characters to get subscripts for svg in charts  
  pollutantData.no2_mean = {file:"euninterp42602AMEANmasterfile.csv",title:"NO\u2082 Annual Concentration",standard:53,units:"ppb",digits:0,pollutantLabel:"NO\u2082 Annual",usedInNatAggRange:[1990,2019]}
  ...
  pollutantData.no2_98 = {file:"euninterp42602P98Vmasterfile.csv",title:"NO\u2082 1-hour Concentration",standard:100,units:"ppb",digits:0,pollutantLabel:"NO\u2082 1-hour",usedInNatAggRange:[1990,2019]}
...
//no2 same for both types
  ...
  pollutantData.ozone = {file:"euninterp44201MAX4Vmasterfile.csv",title:"Ozone 8-hour Concentration",standard:.07,units:"ppm",digits:3,pollutantLabel:"Ozone",usedInNatAggRange:[1990,2019]}
  ...
  pollutantData.pm10 = {file:"euninterp81102MAX2Vmasterfile.csv",title:"PM\u2081\u2080 24-hour Concentration",standard:150,units:"\u03BCg/m\u00B3 ",digits:0,pollutantLabel:"PM\u2081\u2080",usedInNatAggRange:[1990,2019]}
...
//Once I make the chart titles HTML I can use this so that subscripts work in IE 11 
  pollutantData.pm25_mean = {file:"euninterp88101WTDAMmasterfile.csv",title:"PM\u2082.\u2085 Annual Concentration",standard:12,units:"\u03BCg/m\u00B3",digits:1,pollutantLabel:"PM\u2082.\u2085 Annual",minYear:2000,usedInNatAggRange:[2000,2019]}
  ...
  pollutantData.pm25_98 = {file:"euninterp88101P98Vmasterfile.csv",title:"PM\u2082.\u2085 24-hour Concentration",standard:35,units:"\u03BCg/m\u00B3",digits:1,pollutantLabel:"PM\u2082.\u2085 24-hour",minYear:2000,usedInNatAggRange:[2000,2019]}
...
//pm 25 same for both types
  ...
  pollutantData.so2 = {file:"euninterp42401P99Vmasterfile.csv",title:"SO\u2082 1-hour Concentration",standard:75,units:"ppb",digits:0,pollutantLabel:"SO\u2082",usedInNatAggRange:[1990,2019]}
