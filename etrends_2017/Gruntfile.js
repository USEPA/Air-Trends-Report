	...
	concat: {
	  dist: {
		  ...
		  files: {
			...
			'dist/js/cache/etrends-libs.js':['src/js/libs/plugins/modernizr.js','src/js/libs/plugins/bootstrap.js','src/js/libs/plugins/jquery.fullPage_v2_9_4.js','src/js/libs/plugins/TweenMax.min.js','src/js/libs/plugins/ScrollMagic.js','src/js/libs/plugins/animation.gsap.js'],
			'dist/js/cache/etrends-custom.js':['src/js/etrends_structure.js','src/js/EtrendsUtilities.js','src/js/ClassifiedPointsMap.js','src/js/LineAreaChart.js','src/js/MapChartSlider.js','src/js/MapChartTooltip.js','src/js/MapChartResize.js','src/js/MapChartDebounce.js','src/js/StatsCalculator.js','src/js/MapChartLegend.js','src/js/MapChartTitle.js','src/js/MapChartExportMenu.js','src/js/naaqsMapChart.js','src/js/speciation.js','src/js/weather.js','src/js/visibility.js','src/js/toxics.js','src/js/naaqs-concentrations-averages.js','src/js/naaqs-emissions-totals.js','src/js/naaqs-emissions-categories.js','src/js/babyLegend.js','src/js/growth.js','src/js/etrends-d3-main.js']
      },
    },
	  distAll: {
        files: {
