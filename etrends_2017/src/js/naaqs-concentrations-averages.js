...
etrends.naaqs.concentrations.averages.init = function () {
...
//Using hardcoded y ranges and interval for this
  ...
  var ySecondaryRange = [-1500,1500,750];
  ...
  var chartFileName = "data/naaqs/concentrations/inNAAQSconcentrations19902016.csv";
...
//This variation is needed if chart div is relative so that tooltip calculation will use relative calculations
   ...
   chart.ytitle.text='Percent Above or Below NAAQS<br/>Excluding Lead'
   chart.ytitle.units='%'
