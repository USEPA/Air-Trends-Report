...
//Using hardcoded y ranges and interval for this
  ...
  xTickLabels = ["1970","2000","2010","2016"];
...
//This variation is needed if chart div is relative so that tooltip calculation will use relative calculations
   ...
   chart.title.text = 'Comparison of Growth Areas and Declining Emissions<br/><span class="etrends-chart-title-subtitle">1970-2016</span>';
