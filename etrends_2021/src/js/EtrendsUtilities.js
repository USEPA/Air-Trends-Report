...
etrends.library.utilities.setModuleLoadedForEGAM = function(file) {
  ...
  if (window.egam && egam.moduleLoader) {
    ...
    var version = "etrends_2020";
    egam.moduleLoader.setLoaded(":=http://localhost/" + version + "/src/js/" + file,true);
    egam.moduleLoader.setLoaded(":=https://raisz.aa.ad.epa.gov/" + version + "/src/js/" + file,true);
  }    
};
