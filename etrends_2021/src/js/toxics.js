...
//  config.symbology = {colors:[d3.rgb(0,80,81)],breaks:[]};
  ...
  config.types = {};
  config.types.Lead = {fullName:"Lead PM10 LC",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.BenzoPyrene = {fullName:"Benzo(a)pyrene (Total TSP & Vapor)",minYear:2008,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Naphthalene = {fullName:"Naphthalene (Total TSP & Vapor)",minYear:2008,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.VinylChloride = {fullName:"Vinyl Chloride",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.CarbonTetrachloride = {fullName:"Carbon Tetrachloride",minYear:2003,maxYear:2018};
  config.types.EthyleneDichloride = {fullName:"Ethylene Dichloride",minYear:2004,maxYear:2018};
  config.types.Benzene = {fullName:"Benzene",minYear:2003,maxYear:2018};
  config.types.Chloroform = {fullName:"Chloroform",minYear:2003,maxYear:2018};
  config.types.Ethylbenzene = {fullName:"Ethylbenzene",minYear:2003,maxYear:2018};
  config.types.MethyleneChloride = {fullName:"Methylene Chloride",minYear:2003,maxYear:2018};
  config.types.Trichloroethylene = {fullName:"Trichloroethylene",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Butadiene = {fullName:"1,3-Butadiene",minYear:2003,maxYear:2018};
  config.types.Toluene = {fullName:"Toluene",minYear:2003,maxYear:2018};
  config.types.Acetaldehyde = {fullName:"Acetaldehyde",minYear:2003,maxYear:2018};
  config.types.Formaldehyde = {fullName:"Formaldehyde",minYear:2003,maxYear:2018};
  config.types.Tetrachloroethylene = {fullName:"Tetrachloroethylene",minYear:2003,maxYear:2018};
  config.types.Nickel = {fullName:"Nickel PM10 LC",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Manganese = {fullName:"Manganese PM10 LC",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Arsenic = {fullName:"Arsenic PM10 LC",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Cadmium = {fullName:"Cadmium PM10 LC",minYear:2003,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Chromium = {fullName:"Chromium VI LC",minYear:2005,maxYear:2012,multiplier:1000,units:"ng/m\u00B3"};
  config.types.Beryllium = {fullName:"Beryllium PM10 LC",minYear:2004,maxYear:2018,multiplier:1000,units:"ng/m\u00B3"};
