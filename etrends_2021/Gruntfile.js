	...
	concat: {
	  dist: {
		  ...
		  files: {
			...
			'dist/js/cache/etrends-libs.js':['src/js/libs/plugins/modernizr.js','src/js/libs/plugins/bootstrap.bundle.js','src/js/libs/plugins/TweenMax.min.js','src/js/libs/plugins/ScrollToPlugin.min.js','src/js/libs/plugins/ScrollMagic.min.js','src/js/libs/plugins/animation.gsap.min.js'],
			...
			'dist/js/cache/etrends-custom.js':['src/js/etrends_structure.js','src/js/EtrendsUtilities.js','src/js/ClassifiedPointsMap.js','src/js/LineAreaChart.js','src/js/MapChartSlider.js','src/js/MapChartTooltip.js','src/js/MapChartResize.js','src/js/MapChartDebounce.js','src/js/StatsCalculator.js','src/js/MapChartLegend.js','src/js/MapChartTitle.js','src/js/MapChartExportMenu.js','src/js/naaqs-emissions-lead.js','src/js/naaqsMapChart.js','src/js/speciation.js','src/js/visibility.js','src/js/toxics.js','src/js/spotlight-MapChart.js','src/js/naaqs-concentrations-averages.js','src/js/naaqs-emissions-totals.js','src/js/naaqs-emissions-categories.js','src/js/babyLegend.js','src/js/growth.js','src/js/etrends-d3-main.js'],
...
//Have to do the setLoaded thing at end so that egam can use moduleLoader				
        {
          append: 'if (egam && egam.moduleLoader) {egam.moduleLoader.setLoaded(":=http://localhost/etrends_2019/dist/js/etrends-chart.js",true);egam.moduleLoader.setLoaded(":=https://gisdev5.rtpnc.epa.gov/etrends_2019/dist/js/etrends-chart.js",true);}',
        ...
        {
          append: 'if (egam && egam.moduleLoader) {egam.moduleLoader.setLoaded(":=http://localhost/etrends_2019/dist/js/etrends-chart.min.js",true);egam.moduleLoader.setLoaded(":=https://gisdev5.rtpnc.epa.gov/etrends_2019/dist/js/etrends-chart.min.js",true);}',
