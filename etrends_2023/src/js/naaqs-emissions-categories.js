...
//just for convenience define these monster functions at the bottom   
  ...
  chart.toggleYdomainToPercentMakeChart = function () {
    //This because they don't want to hide series if y axis is in percent
    chart.legend.AllowHiddenSeries = chart.convertYdomainToPercent ? false : true;
    //if show totals was unchecked we don't want any series to stay hidden if they were
    ...
    if (chart.convertYdomainToPercent) {
      ...
      //Have to revert back to showing totals before redrawing chart
      //or else the animation doesn't look right
      if (redrawChart) {
