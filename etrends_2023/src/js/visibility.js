...
//  config.symbology = {colors:[d3.rgb(0,80,81)],breaks:[]};
  ...
  config.types = {};
	config.types.clearest = {file:"clearest_2000-2021.csv",title:"Visibility Trend on Clearest Days",units:"deciview",digits:1,typeLabel:"Clearest",tooltip:"Click to view visibility trends on 20 percent clearest days"}
...
//	config.types.haziest = {file:"haziest.csv",title:"Haziest Visibility National Trend",standard:9,units:"indexppm",digits:1,typeLabel:"Haziest",tooltip:""}
	config.types.impaired = {file:"impaired_2000-2021.csv",title:"Visibility Trend on Most Impaired Days",units:"deciview",digits:1,typeLabel:"Most Impaired",tooltip:"Click to view visibility trends on 20 percent most impaired days"}
