...
etrends.naaqs.init = function (D3QueueCallback) {
  var defaultMinYear = 1990;
	var yearRange = [defaultMinYear,2017];
...
//Set up the Map parameters for each pollutant  
  ...
  pollutantData.co = {file:"euninterp42101MAX2V19902017.csv",title:"CO 8-hour Concentration",standard:9,units:"ppm",digits:1,pollutantLabel:"CO"}
...
//Note used unicode characters to get subscripts for svg in charts  
  pollutantData.pb = {file:"euninterp14129RQMAXmasterfile.csv",title:"Pb 3-month Concentration",standard:.15,units:"\u03BCg/m\u00B3",digits:2,pollutantLabel:"Lead",usedInNatAggRange:[2010,2017]}
...
//Note used unicode characters to get subscripts for svg in charts  
  pollutantData.no2_mean = {file:"euninterp42602AMEAN19902017.csv",title:"NO\u2082 Annual Concentration",standard:53,units:"ppb",digits:0,pollutantLabel:"NO\u2082 Annual"}
  ...
  pollutantData.no2_98 = {file:"euninterp42602P98V19902017.csv",title:"NO\u2082 1-hour Concentration",standard:100,units:"ppb",digits:0,pollutantLabel:"NO\u2082 1-hour"}
...
//no2 same for both types
  ...
  pollutantData.ozone = {file:"euninterp44201MAX4V19902017.csv",title:"Ozone 8-hour Concentration",standard:.07,units:"ppm",digits:3,pollutantLabel:"Ozone"}
  ...
  pollutantData.pm10 = {file:"euninterp81102MAX2V19902017.csv",title:"PM\u2081\u2080 24-hour Concentration",standard:150,units:"\u03BCg/m\u00B3 ",digits:0,pollutantLabel:"PM\u2081\u2080"}
...
//Once I make the chart titles HTML I can use this so that subscripts work in IE 11 
  pollutantData.pm25_mean = {file:"euninterp88101WTDAM20002017.csv",title:"PM\u2082.\u2085 Annual Concentration",standard:12,units:"\u03BCg/m\u00B3",digits:1,pollutantLabel:"PM\u2082.\u2085 Annual",minYear:2000}
  ...
  pollutantData.pm25_98 = {file:"euninterp88101P98V20002017.csv",title:"PM\u2082.\u2085 24-hour Concentration",standard:35,units:"\u03BCg/m\u00B3",digits:1,pollutantLabel:"PM\u2082.\u2085 24-hour",minYear:2000}
...
//pm 25 same for both types
  ...
  pollutantData.so2 = {file:"euninterp42401P99V19902017.csv",title:"SO\u2082 1-hour Concentration",standard:75,units:"ppb",digits:0,pollutantLabel:"SO\u2082"}
