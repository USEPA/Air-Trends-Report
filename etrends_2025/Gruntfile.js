...
*/	
	...
	concat: {
	  dist: {
		  ...
		  files: {
			...
			'dist/js/cache/etrends-libs.js':['src/js/libs/plugins/modernizr.js','src/js/libs/plugins/bootstrap.bundle.js','src/js/libs/plugins/TweenMax.min.js','src/js/libs/plugins/ScrollToPlugin.min.js','src/js/libs/plugins/ScrollMagic.min.js','src/js/libs/plugins/animation.gsap.min.js','src/js/libs/plugins/esri-loader-3.3.0.js'],
			...
			//not showing these in 225 anymore => 'src/js/toxicsCensusTract.js','src/js/spotlight-MapChart.js'
			'dist/js/cache/etrends-custom.js':['src/js/etrends_structure.js','src/js/EtrendsUtilities.js','src/js/ClassifiedPointsMap.js','src/js/LineAreaChart.js','src/js/MapChartSlider.js','src/js/MapChartTooltip.js','src/js/MapChartResize.js','src/js/MapChartDebounce.js','src/js/StatsCalculator.js','src/js/MapChartLegend.js','src/js/MapChartTitle.js','src/js/MapChartExportMenu.js','src/js/NumberLine.js','src/js/naaqs-emissions-lead.js','src/js/naaqsMapChart.js','src/js/speciation.js','src/js/visibility.js','src/js/toxics.js','src/js/toxics-cancerRisk-barChart.js','src/js/naaqs-concentrations-averages.js','src/js/naaqs-emissions-totals.js','src/js/naaqs-emissions-categories.js','src/js/babyLegend.js','src/js/growth.js','src/js/etrends-d3-main.js'],
			'dist/js/etrends-chart.js':['src/js/EtrendsUtilities.js','src/js/LineAreaChart.js','src/js/MapChartTooltip.js','src/js/MapChartResize.js','src/js/MapChartDebounce.js','src/js/MapChartLegend.js','src/js/MapChartTitle.js','src/js/MapChartExportMenu.js','src/js/NumberLine.js']
	  },
    },
	  distAll: {
        files: {
      ...
      //},
	  distcss: {
		  //src: ['src/css/A_bootstrap.css','src/css/A_etrends_structure.css','src/css/B_preloader.css','src/css/C_fullpage.css','src/css/D_video_backgrounds.css','src/css/E_navbar.css','src/css/F_icon-font-style.css','src/css/G_bootstrap_overrides.css','src/css/H_d3.slider.css','src/css/I_naaqsMap.css','src/css/J_naaqsChart.css','src/css/K_accessibility.css','src/css/L_print.css'],
          src: ['src/css/B_etrends_structure.css','src/css/C_preloader.css','src/css/D_video_backgrounds.css','src/css/F_icon_font_style.css','src/css/G_bootstrap_overrides.css','src/css/H_d3.slider.css','src/css/I_naaqsMap.css','src/css/J_naaqsChart.css','src/css/K_accessibility.css'],
		  dest: 'dist/css/<%= pkg.name %>.css'
	  },	
    },
    uglify: {
  ...
  file_append: {
    ...
    etrends_chart: {
      files: [
//Have to do the setLoaded thing at end so that egam can use moduleLoader				
        {
		  append: 'if (egam && egam.moduleLoader) {egam.moduleLoader.setLoaded(":=http://localhost/etrends_' + version + '/dist/js/etrends-chart.js",true);egam.moduleLoader.setLoaded(":=https://raisz.epa.gov/etrends_' + version + '/dist/js/etrends-chart.js",true);egam.moduleLoader.setLoaded(":=https://gispub.epa.gov/air/trendsreport/' + version + '/dist/js/etrends-chart.js",true);}',
          input: 'dist/js/etrends-chart.js'
        },
        {
          append: '//# sourceURL=etrends/etrends-chart.js',
          input: 'dist/js/etrends-chart.js'
        },
        {
		  append: 'if (egam && egam.moduleLoader) {egam.moduleLoader.setLoaded(":=http://localhost/etrends_' + version + '/dist/js/etrends-chart.min.js",true);egam.moduleLoader.setLoaded(":=https://raisz.epa.gov/etrends_' + version + '/dist/js/etrends-chart.min.js",true);egam.moduleLoader.setLoaded(":=https://gispub.epa.gov/air/trendsreport/' + version + '/dist/js/etrends-chart.min.js",true);}',
          input: 'dist/js/etrends-chart.min.js'
        },
        {
          append: '//# sourceURL=etrends/etrends-chart.min.js',
          input: 'dist/js/etrends-chart.min.js'
        }	
      ]
    }
...
//  grunt.loadNpmTasks('babel-preset-es2015');
  ...
  grunt.registerTask('default', ['concat:dist','uglify:distCustom','concat:distAll','concat:distcss','cssmin','csslint','clean:tempfiles','file_append:default_options']);
