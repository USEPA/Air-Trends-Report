 ...
 */
	...
	$(document).ready(function () {
		...
		//Make sure the link exists because it looks like David removed it
		if (link) link.setAttribute("src","https://files.airnowtech.org/airnow/today/forecast_aqi_"+ ConvertJSdateToAQIdateFormat(new Date())+"_usa.jpg");
		
		var timestampLink = $("#forecasttimestamp");
		var currentDate = new Date();
		timestampLink.html("Updated " + currentDate.toDateString())
	});	
