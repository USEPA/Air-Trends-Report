...
//Not showing this in 2025 anymore but keep code in here for reference
//    .defer(function (cb) {setTimeout(etrends.toxics.cancerRisk.barChart.init.bind(etrends.toxics.cancerRisk.barChart,cb),0)})
//Not showing this in 2025 anymore but keep code in here for reference
//    .defer(function (cb) {setTimeout(etrends.toxicsCensusTract.init.bind(etrends.toxicsCensusTract,cb),0)})
// Don't show the 2020 spotlights anymore but keep code in here for refrence
//    .defer(function (cb) {setTimeout(etrends.spotlight.init.bind(etrends.spotlight.covid,cb,'covid'),0)})
//    .defer(function (cb) {setTimeout(etrends.spotlight.init.bind(etrends.spotlight.covid,cb,'wildfires'),0)})
/*
