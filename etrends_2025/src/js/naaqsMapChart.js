...
//Set up the Map parameters for each pollutant  
  ...
  pollutantData.co = {file:"euninterp42101MAX2Vmasterfile.csv",title:"CO 8-hour Concentration",standard:9,units:"ppm",digits:1,pollutantLabel:"CO",usedInNatAggRange:[1990,2024]}
...
//Note used unicode characters to get subscripts for svg in charts  
  pollutantData.pb = {file:"euninterp14129RQMAXmasterfile.csv",title:"Pb 3-month Concentration",standard:.15,units:"\u03BCg/m\u00B3",digits:2,pollutantLabel:"Lead",usedInNatAggRange:[2010,2024]}
...
//Note used unicode characters to get subscripts for svg in charts  
  pollutantData.no2_mean = {file:"euninterp42602AMEANmasterfile.csv",title:"NO\u2082 Annual Concentration",standard:53,units:"ppb",digits:0,pollutantLabel:"NO\u2082 Annual",usedInNatAggRange:[1990,2024]}
  ...
  pollutantData.no2_98 = {file:"euninterp42602P98Vmasterfile.csv",title:"NO\u2082 1-hour Concentration",standard:100,units:"ppb",digits:0,pollutantLabel:"NO\u2082 1-hour",usedInNatAggRange:[1990,2024]}
...
//no2 same for both types
  ...
  pollutantData.ozone = {file:"euninterp44201MAX4Vmasterfile.csv",title:"Ozone 8-hour Concentration",standard:.07,units:"ppm",digits:3,pollutantLabel:"Ozone",usedInNatAggRange:[1990,2024]}
  ...
  pollutantData.pm10 = {file:"euninterp81102MAX2Vmasterfile.csv",title:"PM\u2081\u2080 24-hour Concentration",standard:150,units:"\u03BCg/m\u00B3 ",digits:0,pollutantLabel:"PM\u2081\u2080",usedInNatAggRange:[1990,2024]}
...
//Note: got rid of pm 2.5 standard of 9 on 4/23/2025
  pollutantData.pm25_mean = {file:"euninterp88101WTDAMmasterfile.csv",title:"PM\u2082.\u2085 Annual Concentration",standard:9,units:"\u03BCg/m\u00B3",digits:1,pollutantLabel:"PM\u2082.\u2085 Annual",minYear:2000,usedInNatAggRange:[2000,2024]}
  ...
  pollutantData.pm25_mean.breaks = [4.4,9.0,35.4];  
  ...
  pollutantData.pm25_98 = {file:"euninterp88101P98Vmasterfile.csv",title:"PM\u2082.\u2085 24-hour Concentration",standard:35,units:"\u03BCg/m\u00B3",digits:1,pollutantLabel:"PM\u2082.\u2085 24-hour",minYear:2000,usedInNatAggRange:[2000,2024]}
...
//pm 25 same for both types
  pollutantData.pm25_98.breaks = [9.0,35.4,55.4];
  ...
  pollutantData.so2 = {file:"euninterp42401P99Vmasterfile.csv",title:"SO\u2082 1-hour Concentration",standard:75,units:"ppb",digits:0,pollutantLabel:"SO\u2082",usedInNatAggRange:[1990,2024]}
...
//Set the step between ticks or tick size
   ...
   concentrationChart.getYdomain =  function (self) {
     var min = self.standard || 0;
     var max = self.standard || 0;
...
//Note: set initial value to max. if intial value is not set then it will default to min value
  var naaqsSliderIntialValue = yearRange[1];
  var naaqsSlider = new MapChartSlider("naaqsSlider",yearRange[0],yearRange[1],1,1,1,xTickSize,onSlide,null,naaqsSliderIntialValue);
...
//        console.log('draw paths');
    ...
    //Draw standard if it was set up (truthy or zero)
      if (self.standard || self.standard==0) {
          self.standardLine = d3.svg.line()
          //    .interpolate('basis')
              .x(function (d) { return self.xScale(d.year); })
              .y(function (d) { return self.yScale(self.standard); });
      } else {
          self.standardLine = null;
      }
      ...
      //draw standard line if it is set up
      if (self.standardLine) {
